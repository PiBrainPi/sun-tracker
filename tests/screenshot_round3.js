#!/usr/bin/env node
/** Screenshots Runde 3: Solstitiums-Vergleich (Y-Achse tief), Polar (NW), Sonnenaufgang (HH:MM). */
...
(async () => {
  ...
  try {
    ...
    for (const [id, file] of [['c3','diagramm_solstitien_hoehe'],['c5','diagramm_polar_nw'],['c11','diagramm_sonnenaufgang_hhmm']]) {
    ...
    console.log('Screenshots Runde 3 erstellt');

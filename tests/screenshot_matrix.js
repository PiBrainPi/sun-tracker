#!/usr/bin/env node
/**
 * Screenshot der neuen Tageslängen-Zahlenwert-Matrix (Tag × Monat).
 */
...
(async () => {
  ...
  try {
    ...
    // Zur Matrix-Box scrollen
    const box = page.locator('.chart-box[data-chart="c9"]');
    await box.scrollIntoViewIfNeeded();
    await page.waitForTimeout(300);
    await box.screenshot({ path: path.resolve(__dirname, '../assets/matrix_zahlenwerte.png') });
    console.log('Matrix-Screenshot erstellt');

#!/usr/bin/env node
/** Screenshot Runde 5: c13 (kombinierter Aufgang+Untergang). */
...
(async () => {
  ...
  try {
    ...
    const box = page.locator('.chart-box[data-chart="c13"]');
    await box.scrollIntoViewIfNeeded();
    await page.waitForTimeout(150);
    await box.screenshot({ path: path.resolve(__dirname, '../assets/diagramm_aufgang_untergang.png') });
    console.log('Screenshot c13 erstellt');
